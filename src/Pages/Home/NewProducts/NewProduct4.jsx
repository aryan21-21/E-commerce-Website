...
import NewProduct4Img from "../../../assets/Products/NewProducts/NewProduct4.jpeg";
import { MyContext } from '../../../App'; // ✅ Ensure path is correct

function NewProduct4() {
    ...
    <div>
      <div className="productItem border rounded p-3 text-start">
        ...
        <div className="imgWrapper mb-3 position-relative">
          ...
          <span className="badge bg-primary position-absolute top-0 start-0 m-2">41%</span>
        </div>
