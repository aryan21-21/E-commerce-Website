...
import Pro5 from "../../../assets/Products/Pro5.jpeg";
    ...
    <div>
      <div className="productItem border rounded position-relative p-3 text-start">
        ...
        <div className="imgWrapper mb-3 position-relative">
          ...
          <span className="badge bg-primary position-absolute top-0 start-0 m-2">12%</span>
        </div>

        {/* Product Info */}
        <div className="info">
          <h6 className="fw-bold">Blueberries <br />1 Pint Package</h6>
